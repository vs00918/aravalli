...
* [**`roots/emergence-invariants-and-local-rule-networks.md`**](./roots/emergence-invariants-and-local-rule-networks.md)  
  *Philip Anderson's "More is Different", non-linear network interactions, and macroscopic order generated by decentralized local threshold heuristics.*
* [**`roots/marginal-propensity-to-consume-and-poverty-traps.md`**](./roots/marginal-propensity-to-consume-and-poverty-traps.md)  
  *Effective Marginal Tax Rate ($\text{EMTR} > 1.0$) welfare cliffs, Keynesian multiplier dynamics, and cash transfer efficiency.*
...
* [**`trunk/decentralized-superorganisms-and-swarm-intelligence.md`**](./trunk/decentralized-superorganisms-and-swarm-intelligence.md)  
  *Ant colony olfactory encounter switching, Kuramoto pacemaker phase synchronization, and the emergence of human national superorganisms.*
* [**`trunk/unconditional-floors-vs-welfare-cliffs.md`**](./trunk/unconditional-floors-vs-welfare-cliffs.md)  
  *Administrative deadweight loss of means-testing, scarcity cognitive bandwidth tax, and worker bargaining power.*
...
* [**`branches/complex-adaptive-systems-and-cellular-automata.md`**](./branches/complex-adaptive-systems-and-cellular-automata.md)  
  *Conway's Game of Life, Wolfram complexity classes, self-organized criticality (sandpile avalanches), and computation at the edge of chaos.*
* [**`branches/universal-basic-income-architectures-and-automation.md`**](./branches/universal-basic-income-architectures-and-automation.md)  
  *Land Value Taxation (Georgism), Carbon Fee & Dividend, Sovereign Wealth Funds (Alaska Model), and AI automation dividends.*
...
* [**`leaves/kurzgesagt-emergence-how-stupid-things-become-smart.md`**](./leaves/kurzgesagt-emergence-how-stupid-things-become-smart.md)  
  *Deconstruction of Kurzgesagt's "Emergence": The wetness of water, stigmergic ant task switching, cardiac synchronization, and national superorganisms.*
* [**`leaves/kurzgesagt-universal-basic-income-ubi.md`**](./leaves/kurzgesagt-universal-basic-income-ubi.md)  
  *Deconstruction of Kurzgesagt's "Universal Basic Income": The welfare cliff, Canadian Mincome results, and fiscal stimulus multipliers.*
