# Mind of Aravalli — 15-Minute High-Yield Revision Sprint

**Capsule Type:** `SPRINT_15MIN` | **Total Topics:** `3` | **Revision Load:** `15 min` | **Active Prompts:** `13`
...
## 3. 100 Agniveg Jet Kamikaze Drones
- **ID:** `ca-100-agniveg-jet-kamikaze-drones` | **Priority:** `P3_MODERATE` | **Category:** `NATIONAL_AND_STATES` | **Time:** `1 min`

### Must Memorize Facts:
- Delivered to Indian Army by SMPP Ltd (180 km range, 450 kmph).

### Active Recall Cards:
- **Q1:** Key factual rule for: 100 Agniveg Jet Kamikaze Drones
  - **A:** Delivered to Indian Army by SMPP Ltd (180 km range, 450 kmph).
