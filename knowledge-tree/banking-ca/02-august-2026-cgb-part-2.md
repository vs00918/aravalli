...
**What Happened**
* **Lending Rate Harmonisation → Draft Master Directions 2026:**
  * RBI issued draft directions on benchmark pricing, reset frequency, and interest rate transparency.
...
10. **PFRDA 'NPS e-Shramik' Model for Gig Workers**:
    * Platform Service Partner model for gig workers under NPS Corporate structure without fixed contribution caps.
    * 🎯 **Recap:** *NPS e-Shramik platform model launched for gig workers.*
11. **LIC Gets RBI Approval to Raise Stake in HDFC Bank up to 9.99%**:
    * Raised allowable stake from 4.11% up to **9.99%**.
    * 🎯 **Recap:** *LIC approved to increase HDFC Bank stake to 9.99%.*
12. **Apex Appointments**:
    * **Anurag Jain**: CEO, NITI Aayog.
    * **Shabnam Sinha**: Non-Executive Chairperson, Airtel Payments Bank.
    * 🎯 **Recap:** *Anurag Jain (NITI Aayog CEO), Shabnam Sinha (Airtel Payments Bank Chair).*
...
### 2. Time-Aware Revision Delta (August 12–20 Batch)
