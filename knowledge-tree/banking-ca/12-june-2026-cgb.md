# Banking & Financial Current Affairs — June 2026 (CGB Mentors Master Feed)

**Source:** CGB Mentors Current Affairs (1st – 30th June 2026)  
**Target Window:** June 2026 (Batch: 1–30 June 2026)  
...
### 1. 61st RBI Monetary Policy Committee (MPC) Meeting: Repo Rate Held at 5.25% & FPI G-Sec Limit Overhaul
...
* FY27 Real GDP projection (6.6%) and CPI inflation projection (5.1%).
* FPI equity ceilings under revised FEMA rules: 10% individual, 24% aggregate.
* FAR tenors expanded: 15, 30, 40-year G-Secs and 5, 7, 10, 15, 30, 40-year Green Bonds.
* Export proceeds realisation timeline: 9 months.

---

### 2. RBI Final Directions: Commercial Bank Lending to Real Estate Investment Trusts (REITs) & InvITs
* **Priority:** P1 — Critical / Deep
...
* Operational cash-flow requirement: 80% of assets for at least 1 year.
* Bank capital base ceiling: 10% of eligible capital base.
* Risk weights: 100% (CRE), 125% (Capital Market), 150% (Overseas branches).
* Prohibition of bullet/balloon repayment structures.
* Effective date: October 1, 2026.

---

### 3. RBI Overhauls Forex Inflow Architecture: US Dollar-Rupee Swap Facilities & CRR/SLR Exemptions
* **Priority:** P1 — Critical / Deep
* **Category:** BANKING_REGULATION
* **Institution:** RBI
...
* Swap cost for PSU ECBs/OFCBs: 1.5% per annum compounded semi-annually.
* Minimum transaction unit: Multiples of USD 1 million.
* Lock-in period on swapped FCNR(B) deposits: 1 year.
* Coverage limitation: Swap covers principal only, excludes interest.

---

### 4. RBI Revised Framework on Limiting Customer Liability in Digital Banking Transactions
* **Priority:** P1 — Critical / Deep
...
* Mandatory reporting deadline: 5 calendar days to bank & Helpline 1930.
* Transaction alert threshold: Above ₹500.
* Shadow reversal timeline: 5 days (credit cards).
* Dispute resolution turnaround: 45 days (domestic), 60 days (cross-border).
* Effective date: January 1, 2027.

---

### 5. RBI Master Directions on Control, Assurance & Corporate Governance in Commercial Banks
* **Priority:** P1 — Critical / Deep
* **Category:** BANKING_REGULATION
* **Institution:** RBI
...
* Timeline to report CRO exit/appointment to RBI: 5 working days.
* Prohibition of third-party sales incentives to bank employees.
* Mandatory kill-switch and board approval in Model Risk Management Framework (MRMF).
* Effective date: January 1, 2027.

---

### 6. RBI Final Directions on Trade Receivables Discounting System (TReDS) & Platform Net Worth
* **Priority:** P1 — Critical / Deep
* **Category:** BANKING_REGULATION
* **Institution:** RBI
...
* **TReDS Architecture & Parameters Ladder:**
  ...
  * 🎯 **Recap:** *TReDS platform net worth: ₹25 Cr (deadline March 31, 2028)  •  Insurance premium barred from MSMEs  •  5 authorised platforms.*
...
* Statutory rule on insurance premium: Must not be borne by MSME sellers.
* Total number of authorised TReDS platforms in India: 5 platforms.

---

### 7. RBI Financial Stability Report (June 2026): Macro-Financial Health & Household Debt Dynamics
* **Priority:** P1 — Critical / Deep
...
* Largest segment in non-housing retail loans: Gold loans.
* Bank guarantee margin for stock brokers: 100% collateral with minimum 50% in cash (effective July 1, 2026).
* Asset size cutoff for NBFC Upper Layer: ₹1 lakh crore.
...
* **Must Memorize Facts:**
  * **StAR NPS Parameters:**
    * Developed by **BSE Technologies (BTPL)**  •  Registration fee: **₹200 + GST**  •  Eligibility: **18 to 85 years**  •  Sandbox fintech min net worth: **₹10 Lakh**.
  * 🎯 **Recap:** *StAR NPS onboarding by BSE Tech  •  ₹200 fee  •  Ages 18–85.*
...
* **Must Memorize Facts:**
  * **BoP Highlights:**
    * Q4 Current Account Surplus: **$7.1 Billion (0.7% of GDP)**  •  Full-Year CAD: **$25.2 Billion (0.6% of GDP)**  •  Net FDI: **$6.9 Billion**.
  * 🎯 **Recap:** *Q4 CAD surplus: $7.1B (0.7% GDP)  •  Full FY26 CAD: 0.6% GDP  •  Net FDI: $6.9B.*
...
* **Must Memorize Facts:**
  ...
  * 🎯 **Recap:** *SEBI 214th: 66-day buyback window  •  10-day GARUDA AIF approval  •  Dynamic ETF bands.*
...
* **Must Memorize Facts:**
  * **Lead Bank Framework:**
    * Mandated exclusive **Lead District Manager (LDM)** with separate budget  •  Formalised **Block Level Bankers' Committee (BLBC)**.
  * 🎯 **Recap:** *Exclusive LDM appointed for each district  •  BLBC formalised as grassroots planning tier.*
...
* **Must Memorize Facts:**
  * **KCC Rules:**
    * Deferred to **January 1, 2027**  •  Collateral waived up to **₹2 Lakh** (₹3 Lakh with crop hypothecation tie-ups).
  * 🎯 **Recap:** *KCC directions deferred to Jan 1, 2027  •  Collateral waived up to ₹2 Lakh.*
...
* **Must Memorize Facts:**
  * **PoP Audit Intervals:**
    * Cat-I ($<10 k$ subscribers): Audited **once in 3 years** (1st due June 30, 2029).
    * Cat-II (≥ 10 k$ subscribers): Audited **every year** (1st due June 30, 2027).
  * 🎯 **Recap:** *PoP audit: Annual for ≥ 10 k$ subscribers  •  Every 3 yrs for $<10 k$ subscribers.*
...
* **Must Memorize Facts:**
  * **MTF Broker Limits:**
    * Broker min net worth raised to **₹5 Crore**  •  Leverage up to **5.5 times net worth** (single client cap 10%).
  * 🎯 **Recap:** *MTF broker net worth: ₹5 Cr  •  5.5x leverage multiplier.*
...
* **Must Memorize Facts:**
  ...
  * 🎯 **Recap:** *World Bank: India 6.6% (2026) / 7.2% (2027)  •  OECD: India 6.3% (2026).*
...
* **Must Memorize Facts:**
  * **Regulatory Fee & Capital Changes:**
    * Amalgamation fee slashed to **₹10 Lakh**  •  Foreign reinsurer parent NOF cut to **₹1,000 Crore**  •  AI panel chaired by **Sandeep Shukla**.
  * 🎯 **Recap:** *Amalgamation fee cut to ₹10L  •  Foreign reinsurer NOF: ₹1,000 Cr  •  Sandeep Shukla chairs AI panel.*
...
* **Sports Milestones**:
  ...
  * **SAFF Women's Championship 2026:** India beat Bangladesh 3-1 (6th title).
  * **Cricket Records:** Deepti Sharma equalled Jhulan Goswami's record of 355 international wickets; Harmanpreet Kaur became first player to play 200 T20Is.
...
* **Corporate Mitra Scheme:** MCA programme for MSME compliance certification (₹3,000 fee, 150 hrs online + 6 months practical).
* **Soiled Notes Disposal:** Fell to 17 billion pieces in FY26 due to Shredding and Briquetting Systems (SBS) replacement.
* **Mogaveera Co-operative Bank:** Withdrawal capped at ₹1 lakh for 6 months (DICGC ₹5 lakh insurance).
* **IIFCL SIFTI Flexibility:** 20% project cost lending ceiling removed on IIFCL.
* **Uzbekistan Joins NDB:** Became 10th member of New Development Bank (first Central Asian nation).
* **NIXI Platforms:** Launched IX Portal, myIRINN, Auction Portal, and AI WHOIS screening.
* **Skydo Payment Licence:** First Indian cross-border fintech licensed in Canada under RPAA.
* **World Bank Climate Goal:** Retired 45% annual lending allocation goal for climate co-benefits.

---

# PART 5: IGNORE / FILTERED OUT (0 MIN REVISION)

* Local municipal QR feedback systems (Amdavad Municipal Corporation).
* Celebrity brand endorsements (Shah Rukh Khan for Visa, MS Dhoni for DRiV, Aishwarya Rai for JW Marriott).
* Bizarre trivia records (Underwater human stack in Andaman, Red-wattled lapwing study in Rajasthan).
