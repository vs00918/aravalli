...
## Chapter 2: The Neurochemistry of Focus — The Dopamine-Attention Transition & Dopamine Loading
...
```mermaid
graph LR
    subgraph Destructive_Cycle [Destructive Cycle: Superstimulus Relapse]
    ...
    subgraph Buffer_Sustained [Optimal Architecture: Natural Dopamine Buffer]
...
```mermaid
graph TD
    A[Afternoon Cognitive Exhaustion] 
    --> B[10-20 Minute NSDR / Body Scan Protocol]
    --> C[Parasympathetic Nervous System Activation]
    --> D[Striatal Dopamine Reserves Restored + Prefrontal Reboot]
```
