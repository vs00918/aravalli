# Banking & Financial Current Affairs — July 2026 (Top 50 MCQs & Deep Intelligence)

**Source:** CGB Mentors CA July 2026 Top 50 MCQs (Sapna Ma'am Batch)  
**Target Window:** July 2026 (Consolidated Banking & Macro Intelligence)  
**Compilation Mode:** Canonical Master Notes & High-Yield Exam Drills  

---

# PART 1: P1 — CRITICAL EXAM INTELLIGENCE

### 1. PFRDA Digital Architecture: NPS PRIDE-Disha & Pension Sahayak Redressal
...
#### What Happened
* **Pension Performance Benchmarking & Grievance Digitalisation:**
  * PFRDA rolled out **NPS PRIDE-Disha** and **Pension Sahayak** for NPS, UPS, and APY subscribers.
  * Standardized XIRR cashflow returns and enforced strict two-tier grievance resolution SLAs.
...
### 2. SEBI Capital Market Investor Protection: Quick Transmission Processing (QTP) & Buyback ISIN Freeze
...
#### What Happened
* **Securities Transmission & Insider Trading Firewalls:**
  * Streamlined inheritance transfers for deceased investors via **Quick Transmission Processing (QTP)**.
  * Mandated automated **ISIN-level freeze on promoter shareholdings** during share buybacks.
...
* Promoter buyback freeze: Applies from Board/Shareholder approval date until offer closure.
* SCORES 2.0 ATR timeline: 21 days.

---

# PART 2: P2 — HIGH (HIGH-YIELD REGULATORY & ECONOMIC DEVELOPMENTS)

### 1. SEBI (Employees' Service) Amendment Regulations 2026: Conflict-of-Interest Firewall
* **Priority:** P2 — High
...
* **Priority:** P2 — High
* **Category:** BANKING_OPERATIONS
* **Institution:** RBI / Govt of India
* **Event Date:** 2026-07-14
* **Must Memorize Facts:**
  * **Polymer Note Rollout:**
    * Approved introduction of **polymer banknotes** in **₹10 and ₹20 denominations** following climatic field trials in 5 cities (Kochi, Mysuru, Jaipur, Bhubaneswar, Shimla).
  * 🎯 **Recap:** *Polymer banknotes approved for ₹10 and ₹20 denominations.*

### 3. Central KYC Registry (CKYC) & 14-Digit KIN Architecture
* **Priority:** P2 — High
* **Category:** BANKING_OPERATIONS
* **Institution:** CERSAI / Ministry of Finance
* **Event Date:** 2026-07-20
* **Must Memorize Facts:**
  * **CKYC Architecture:**
    * Issues **14-digit unique KYC Identification Number (KIN)**; managed by **CERSAI** for single-window lifetime KYC across banking, insurance, and securities.
  * 🎯 **Recap:** *CKYC issues 14-digit KIN managed by CERSAI.*

### 4. WTO Trade Policy Review 2026: India's 10% Export Target by 2047
* **Priority:** P2 — High
* **Category:** MACRO_ECONOMY
* **Institution:** WTO / Commerce Ministry
* **Event Date:** 2026-07-22
* **Must Memorize Facts:**
  * **Trade Policy Highlights:**
    * Target to expand global merchandise export share from **1.8% (2024) to 10% by 2047**; abolished 100%, 125%, 150% ultra-high tariff slabs.
  * 🎯 **Recap:** *India targets 10% global merchandise export share by 2047.*

### 5. UNCTAD World Investment Report 2026: India Ranks 11th in Global FDI
* **Priority:** P2 — High
...
* **Must Memorize Facts:**
  * **Services Index:**
    * Introduced monthly **Index of Services Production (ISP)** with **Base Year 2024–25** to track services output.
  * 🎯 **Recap:** *Index of Services Production (ISP) launched with Base Year 2024–25.*

### 7. IRDAI & IPAI Partnership to Eliminate Digital Insurance Dark Patterns
* **Priority:** P2 — High
* **Category:** INSURANCE_SECTOR
* **Institution:** IRDAI / IPAI
* **Event Date:** 2026-07-26
* **Must Memorize Facts:**
  * **Consumer Protection:**
    * Partnered with **Institute of Public Auditors of India (IPAI)** to eliminate deceptive UI/UX dark patterns and mis-selling.
  * 🎯 **Recap:** *IRDAI + IPAI partnership to eliminate digital insurance dark patterns.*

### 8. FRSB 2020 (Taxable) Rate Maintained at 8.05%
* **Priority:** P2 — High
* **Category:** BANKING_OPERATIONS
* **Institution:** RBI
...
* **Must Memorize Facts:**
  * **Floating Rate Bond:**
    * Coupon maintained at **8.05%** (7.70% NSC base + 0.35% spread) for July–Dec 2026.
  * 🎯 **Recap:** *FRSB 2020 (Taxable) coupon held at 8.05%.*

---

# PART 3: P3 — MODERATE (RAPID-SCAN FACTOIDS & GLOBAL EVENTS)

* **2030 Commonwealth Centenary Games**: Awarded to **Ahmedabad, Gujarat, India** (scheduled for October 2030).
...
* **Clean Air, Healthy Delhi**: ₹8,300 crore environmental project supported by the **World Bank**.
* **Exercise Pitch Black 2026**: Multinational air combat exercise hosted by **Australia** (RAAF Darwin/Tindal).
