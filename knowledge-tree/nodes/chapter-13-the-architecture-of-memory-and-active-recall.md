...
## Chapter 9: The Architecture of Memory — Active Recall & The Science of Elite Retention
...
```mermaid
graph TD
    subgraph Lobdell_Cycle [The Lobdell 30/5 Cognitive Reset]
    ...
    subgraph Stimulus_Control [Environmental Stimulus Control]
...
```mermaid
graph TD
    subgraph Notecard_Pipeline [The 3-Phase Notecard Knowledge Pipeline]
